...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPaintPageFill.setColor(ContextCompat.getColor(context, R.color.default_circle_indicator_page_color));
        mPaintStroke.setStyle(Paint.Style.STROKE);
        mPaintStroke.setColor(ContextCompat.getColor(context, R.color.default_circle_indicator_stroke_color));
        mPaintStroke.setStrokeWidth(res.getDimension(R.dimen.default_circle_indicator_stroke_width));
        mPaintFill.setStyle(Paint.Style.FILL);
        mPaintFill.setColor(ContextCompat.getColor(context, R.color.default_circle_indicator_fill_color));
