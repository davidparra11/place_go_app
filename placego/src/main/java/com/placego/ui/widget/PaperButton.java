...
public class PaperButton extends View {
    ...
    public PaperButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColor = attributes.getColor(R.styleable.PaperButton_paper_color, ContextCompat.getColor(context, R.color.paper_button_color));
        mShadowColor = attributes.getColor(R.styleable.PaperButton_paper_shadow_color, ContextCompat.getColor(context, R.color.paper_button_shadow_color));
        ...
        final int mTextSize = attributes.getDimensionPixelSize(R.styleable.PaperButton_paper_text_size, getResources().getDimensionPixelSize(R.dimen.paper_text_size));
        final int mTextColor = attributes.getColor(R.styleable.PaperButton_paper_text_color, ContextCompat.getColor(context, R.color.paper_text_color));
